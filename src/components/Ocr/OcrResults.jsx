...
const OcrResults = ({ results, isLoading }) => {
      ...
      {results.map((result, index) => (
        ...
        >
          ...
          >
            ...
            <div className="p-5">
              <pre className="whitespace-pre-wrap font-mono text-sm text-zinc-300 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-600 scrollbar-track-transparent">
                {result.text}
              </pre>
            </div>
          </div>
